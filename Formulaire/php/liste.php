...
<head>
    ...
    <link rel="stylesheet" href="css2\liste.css">
...
<body>
    ...
    <div class="navigation">
        ...
        <div class="menuContent">
            ...
            <h4><a href="../Gallery/gallery.html">Gallery</a></h4>
    ...
    <div id="navigationPopup" class="navigationPopup" style="display: none;">
        <h4><a class="content" href="">Home</a></h4>
        <hr>
        <h4><a class="content" href="">Gallery</a></h4>
        <hr>
        <h4><a class="content" href="">About Us</a></h4>
        <hr>
    </div>
    <img class="photonav" src="image/navBack.png" alt="">
    <!-- end navbar -->
  <?php  try{ 
...
$requet=$conx->prepare("SELECT * from etudiant");
		...
		<?php while ( $i< count($rslt)) { ?>
               ...
               <tr>
                ...
                <td><?php echo $rslt[$i]['prenom'];?></td>
                <td><?php echo $rslt[$i]['age'];?></td>
                <td><?php echo $rslt[$i]['sexe'];?></td>
                <td><?php echo $rslt[$i]['mail'];?></td> 
			
				<!-- modifier -->	
                <td> <a href="liste.php?update=<?php echo $rslt[$i]['numInscri']; ?>"><img style="width: 30px" src="image/refresh.png" alt=""></a></td>
               
				  	<!-- supprimer -->


                <td> <a href="del.php?numInscri=<?php echo $rslt[$i]['numInscri'];?> "><img style="width: 30px" src="image/remove.png" alt=""></a></td>
    ...
    <img src="image/footerbackg.png" alt="" class="ftrImg">
    <footer class="ftrContainer">
        <div class="page">
            <h1 class="pageheader">Page</h1>
            <div class="elemContainer">
                <div class="logos">
                    <img src="image/home.png" alt="" class="logoo">
                    <img src="image/Gallery.png" alt="" class="logoo">
                    <img src="image/about.png" alt="" class="logoo">
                </div>
                <div class="textLogos">
        ...
        <div class="connect">
            ...
            <div class="elemContainer">
                <div class="logos">
                    <img src="image/mail.png" alt="" class="logoo">
                    <img src="image/phone.png" alt="" class="logoo">
                </div>
                <div class="textLogos">
        ...
        <div class="contact">
            ...
            <div class="elemContainer">
                <div class="logos">
                    <img src="image/facebook.png" alt="" class="logoo">
                    <img src="image/insta.png" alt="" class="logoo">
                    <img src="image/twitter.png" alt="" class="logoo">
                </div>
                <div class="textLogos">
